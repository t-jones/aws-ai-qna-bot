...
2) Download the file below. The file contains a set of preconfigured questions:
    ...
    <pre>
    https://raw.githubusercontent.com/aws-samples/aws-ai-qna-bot/master/workshops/solar-winds/samples/sun-questions-qna-step-2.json
    </pre>
...
2) Run a script in your Cloud9 IDE that runs CloudFormation to setup an S3 bucket to host the website and uploads two files
    ...
    * Make sure "Block public access to buckets and objects granted through new access control lists (ACLs)" is not selected
    ...
    <pre>
    cd ~/environment/aws-ai-qna-bot/workshops/solar-winds/scripts
    ./setupwebsite.sh
    </pre>
...
8) In the Cloud9 IDE open 
    ```
    QnaBotWorkshop/aws-ai-qna-bot/workshops/solar-winds/web/index.html 
    ```
...
```
https://raw.githubusercontent.com/aws-samples/aws-ai-qna-bot/master/workshops/solar-winds/samples/sun-questions-qna-step-3.json
```
...
14) From the Cloud9 IDE, open the workshops/solar-winds/connect-assets folder and download the qnabot-sample file 
...
```
~/environment/workshops/solar-winds/connect-assets-qnabot-sample
```
...
1) Using the Cloud9 IDE, setup the lambda function by deploying a preconfigured CloudFormation template using sam
    ...
    ```$xslt
    cd ~/environment/aws-ai-qna-bot/workshops/solar-winds/code/solarflare
    npm install
    cd ../../scripts
    ./solarflare-setup.sh
    ./solarflare-pkg.sh
...
1) In your Cloud9 IDE open the file <pre>QnaBotWorkshop/aws-ai-qna-bot/workshops/solar-winds/code/solarflare/app.js</pre>
...
```
https://raw.githubusercontent.com/aws-samples/aws-ai-qna-bot/master/workshops/solar-winds/samples/sun-questions-qna-step-7.json
```
...
3) Create an S3 bucket and allow objects to be public read. Then upload the pdfs from workshops/solar-winds/kendra-assets 
...
```
cd aws-ai-qna-bot/workshops/solar-winds/scripts
./removewebsite.sh
```
